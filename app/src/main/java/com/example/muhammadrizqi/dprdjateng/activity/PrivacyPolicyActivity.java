...
implements View.OnClickListener {
    ...
    public void submitasmara(View view) {
        ...
        if(nameEditText.getText().toString().equals("") || alamatEditText.getText().toString().equals("") || nohpEditText.getText().toString().equals("")
            ...
            Toast.makeText(PrivacyPolicyActivity.this,"Harap Lengkapi Penuh Isian Anda !", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] { "dprdjateng.gmail.com" });
